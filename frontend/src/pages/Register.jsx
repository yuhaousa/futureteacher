    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #1a2035 0%, #2d3561 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ background: '#fff', borderRadius: 16, padding: '40px 44px', width: 400, boxShadow: '0 20px 60px rgba(0,0,0,0.3)' }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: 22, fontWeight: 700, color: '#1a2035', margin: 0 }}>Create Account</h1>
          <p style={{ color: '#7a8294', fontSize: 13, marginTop: 4 }}>Join EduLearn Pro today</p>
        </div>
          ...
          {[
            ...
            <div key={field} style={{ marginBottom: 16 }}>
              ...
              <input type={type} value={form[field]} onChange={e => setForm(f => ({ ...f, [field]: e.target.value }))} required
                style={{ width: '100%', padding: '11px 14px', border: '1.5px solid #e0e3ea', borderRadius: 8, fontSize: 14, color: '#1a2035', outline: 'none', boxSizing: 'border-box' }}
